      ...
      <div className="container px-5 h-auto pt-10 mx-auto text-center lg:px-40  ">
        <div className="text-center">
          ...
          <p className="mb-8 first-letter:font-serif   first-letter:float-left first-letter:font-bold first-letter:text-6xl font-body leading-relaxed text-justify text-sky-950 dark:text-blue-100">
            ...
            eu l'opportunité de participer au développement d'une application
            web innovante, spécialisée dans la création d’e‑learning, Ce stage
            m'a permis de découvrir et de mettre en pratique de nombreuses
          ...
          <ul className="mb-8 font-body leading-loose list-disc  text-justify text-sky-950 dark:text-blue-100">
            ...
            <li>
              ...
              les tickets liés aux fonctionnalités et corrections à implémenter.
            </li>
            <li>
              <span className="font-semibold">
            ...
            <li>
              <span className="font-semibold">Front-end :</span> J'ai développé
              des interfaces utilisateur avec React et TypeScript, en utilisant
              le bundler Vite pour optimiser les performances.
            </li>
            <li>
              <span className="font-semibold">Back-end :</span> J'ai contribué à
              la logique serveur en TypeScript, tout en utilisant Node.js pour
            ...
            <li>
              ...
              J'ai manipulé des bases de données relationnelles avec PostgreSQL,
