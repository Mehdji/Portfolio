      ...
      <div className="scroll-mt-28 container mx-auto flex px-10 py-20 md:flex-row flex-col items-center ">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 font-body  leading-relaxed  text-sky-950 dark:text-blue-100">
            Bienvenue sur mon portfolio ! Je suis étudiant en BTS SIO passionné
            par l'informatique et surtout par le développement. J'aime apprendre
            chaque jour de nouvelles choses, expérimenter, et créer des projets
            concrets. J’ai remarqué que c’est avec de la régularité, de la
            curiosité et une bonne dose de créativité qu’on obtient les
            meilleurs résultats. Mon objectif est simple : développer des
            solutions numériques à la fois utiles et agréables à utiliser, que
            ce soit pour mettre en valeur une entreprise sur le web ou pour
            concevoir des applications innovantes. Ce qui m’anime, c’est avant
            tout résoudre des problèmes concrets en proposant des interfaces
